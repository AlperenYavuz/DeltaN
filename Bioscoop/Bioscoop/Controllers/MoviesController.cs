...
namespace Bioscoop.Models
{
    public class MoviesController : Controller
    {
        ...
        {
            var bioscoopContext = _context.Movie.Include(m => m.Genre);
            return View(await bioscoopContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,ReleaseDate,Price,GenreId")] Movie movie)
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Name", "Name", movie.GenreId);
            return View(movie);
        }
